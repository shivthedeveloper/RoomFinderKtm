    ...
    <div class="row"> 
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Room Detail</b></h2>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            ...
                            <h5 class="mt-5 mb-4 text-secondary">Room Summary</h5>
                    ...
                    <div class="col-lg-4">
                        ...
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            <label class="sr-only">RoomAmount</label>
                        ...
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4 mt-5">Featured Room</h4>
                        ...
                        <div class="sidebar-widget mt-5">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Recently Added Room</h4>
                            <ul class="property_list_widget">
