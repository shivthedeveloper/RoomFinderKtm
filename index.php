...
<!--	Title
	=========================================================-->
<title>Room Finder Site PHP</title>
</head>
<body>
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/room-bg.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                            ...
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-info w-100">Search Room</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-info py-3 m-0"><a href="#">Selling Service</a></h5>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-info py-3 m-0"><a href="#">Rental Service</a></h5>
                                <p>This is a dummy text for filling out spaces. Just some random words...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-info py-3 m-0"><a href="#">Room Listing</a></h5>
                                <p>This is a dummy text for filling out spaces. Just some random words...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-info py-3 m-0"><a href="#">Legal Investment</a></h5>
                                <p>This is a dummy text for filling out spaces. Just some random words...</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-secondary double-down-line text-center mb-4">Recent Room</h2>
                    </div>
                    <!--- <div class="col-md-6">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    <h5 class="text-secondary hover-text-info mb-2 text-capitalize"><a href="propertydetail.php?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                                                    <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-info"></i> <?php echo $row['14'];?></span> </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <div class="left-arrow"><i class="flaticon-investor flat-medium icon-info" aria-hidden="true"></i></div>
                    ...
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <div class="left-arrow"><i class="flaticon-search flat-medium icon-info" aria-hidden="true"></i></div>
                    ...
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <div><i class="flaticon-handshake flat-medium icon-info" aria-hidden="true"></i></div>
                        ...
                        <div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-info my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Room Available</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-info my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Sale Room Available</div>
                            </div>
                        </div>
						<div class="col-md-3">
                            <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                ...
                                <div class="count-num text-info my-4" data-speed="3000" data-stop="<?php 
												...
												echo $total;?>">0</div>
								<?php } ?>
                                <div class="text-white h5">Rent Room Available</div>
                            </div>
                        </div>
                        <div class="col-md-3">
        ...
        <!-- <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Popular Room</h2></div>
                                                </div>
                <div class="col-lg-12">
                    <div class="row">
									...
									<?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where city='Olisphis'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-info text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
                                    <span><?php 
												$total = $row[0];
												echo $total;?> Room Listed</span> </div>
									<?php } ?>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 pb-1">
