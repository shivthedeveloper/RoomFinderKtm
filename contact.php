                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">12 Kirtipur,Kathmandu</span> <br>
										<span class="text-white">12 Kirtipur,Kathmandu</span>
										</div>
                                </li>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-white">roomfinder@gmail.com</span>
										<span class="text-white">roomfinder@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
